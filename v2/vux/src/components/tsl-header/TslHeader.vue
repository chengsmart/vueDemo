<template>
    <div class="vux-header" :class="[position,color]">
        <div class="vux-header-left">
            <slot name="overwrite-left">
                <transition :name="transition">
                    <a class="vux-header-back" @click.preventDefault v-show="_leftOptions.showBack"
                       @click="onClickBack">{{ typeof _leftOptions.backText === 'undefined' ? $t('back_text') : _leftOptions.backText}}</a>
                </transition>
                <transition :name="transition">
...
<style lang="less">
    ...
    .vux-header.relative { position: relative;}
    ...
    .vux-header.light .vux-header-title,
    .vux-header .vux-header-left, .vux-header .vux-header-right,
    .vux-header .vux-header-left a, .vux-header .vux-header-left button, .vux-header .vux-header-right a, .vux-header .vux-header-right button {
        color: #333;
    }
    .vux-header.light .vux-header-left .left-arrow:before {
        border-color: #333;
    }
